...
async function storeFileAsync(req, res) {
    ...
    await fileKeys.map(async function(key) {
        ...
        const response = await imageKit.upload({ file: b64, fileName: file.originalname, extensions: [{ name: "google-auto-tagging", maxTags: 5, minConfidence: 95, }, ], transformation: { pre: "l-text,i-foodogram,fs-10,l-end", post: [{ type: "transformation", value: "w-100", }, ], }, });
